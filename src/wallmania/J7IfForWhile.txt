...
public class J7IfForWhile {
	public static void main(String[] args) {
		...
		try {
			fis = new FileInputStream("/Users/junlee/Java/workspace/LearnJava/src/wallmania/J7IfForWhile.java");
			fos = new FileOutputStream("/Users/junlee/Java/workspace/LearnJava/src/wallmania/J7IfForWhile.txt");
