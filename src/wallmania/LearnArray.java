...
public class LearnArray {
	public static void main(String[] args) {
		...
		for (int i=0; i<5; i++) {
			System.out.print("arr1[" + String.valueOf(i) + "] : " + arr1[i] + "\t");
		}
		...
		for (int i=0; i<5; i++) {
			System.out.print("arr2[" + String.valueOf(i) + "] : " + arr2[i] + "\t");
		}
		...
		for (int i=0; i<5; i++) {
			System.out.printf("%s의 점수를 입력하시오. : ", name[i]); score[i] = scanner.nextInt();
		}
		System.out.print("\n\n");
		for (int i=0; i<5; i++) {
